...
public class RedisServiceImpl implements RedisService {
    ...
    public void addToCache(String key, Object value, long ttlInSeconds) {
        ...
        log.info("REDIS add to cache with ttl -> key: " + key + LOG_STRING1 + value + ", TTL: " + ttlInSeconds);
    }
    ...
    public void updateCache(String key, Object value) {
        redisTemplate.opsForValue().set(key, value);
        log.info("REDIS update cache -> key: " + key + LOG_STRING1 + value);
    }

    public void updateCache(String key, Object value, long ttlInSeconds) {
        redisTemplate.opsForValue().set(key, value);
        redisTemplate.expire(key, ttlInSeconds, TimeUnit.SECONDS);
        log.info("REDIS update cache -> key: " + key + LOG_STRING1 + value + ", TTL: " + ttlInSeconds);
    }
